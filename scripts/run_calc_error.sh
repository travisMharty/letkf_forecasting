...
# declare -a month_day=("4 15" "5 29" "4 2" "4 5" "4 19" "5 7" "5 8" "5 19" "6 3" "6 10" "6 14" "6 15" "4 10" "4 11" "4 12" "4 20" "4 21" "4 22" "4 25" "4 26" "5 5" "5 20" "5 21" "5 22" "5 23" "5 24" "5 25" "5 30" "6 16" "6 17" "6 18" "6 19" "6 22")

declare -a month_day=("4 15" "4 26" "5 29")
...
do
    ...
    echo "${date[@]}"
    echo "wrf"
    python calc_error.py config_wrf.yml -y $year -m ${date[0]} -d ${date[1]}
    ...
    python calc_error.py config_opt_flow_with_div.yml -y $year -m ${date[0]} -d ${date[1]}
